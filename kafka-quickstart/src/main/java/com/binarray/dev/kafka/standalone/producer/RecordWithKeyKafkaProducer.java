 ...
 * @author Ashesh
 */
public class RecordWithKeyKafkaProducer {
    private static final Logger logger = LoggerFactory.getLogger(RecordWithKeyKafkaProducer.class);
    ...
    public static void main(String[] args) {
        ...
        try (var kafkaProducer = new KafkaProducer<String, String>(producerProperties)) {
            String topic = "binarray_dev_topic";
            for (int i = 0; i < 10; i++) {
